...
while True:
    ...
    spaceship_velocity[0] -= spaceship_velocity[0]*spaceship_drag_coefficient # decrement the velocity by the velocity * the drag coefficient
    spaceship_velocity[1] -= spaceship_velocity[1]*spaceship_drag_coefficient # for both x and y
